...
def convert_directory_images_to_webp(input_dir, output_dir):
...
def main():
    input_directory = input("Insira o caminho do diretório de imagens JPG/PNG: ").strip()
    ...
    convert_directory_images_to_webp(input_directory, output_directory)
